...
authenticate("pdxdvbthompson01.vm.iovationnp.com:7474", "neo4j", "10vation")

# connect to authenticated graph database
graph = Graph("http://pdxdvbthompson01.vm.iovationnp.com:7474/db/data/")

#graph.schema.create_uniqueness_constraint("Host","ip")

n = graph.data("MATCH (n:Target) RETURN n.ip")
print(n)

for lst, results in enumerate(n):
    dest = n[lst]["n.ip"]
    print(dest)
